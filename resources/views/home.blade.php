...
@section('content')
    ...
    <section class="hero" aria-label="Introduction"
        style="
        background-image:
            linear-gradient(rgba(66, 58, 36, 0.60), rgba(66, 58, 36, 0.60)),
            url('{{ $homeSetting && $homeSetting->hero_image
                ? asset($homeSetting->hero_image)
                : asset('images/superior-king.jpg') }}');
    ">
        <div class="hero-copy">
            ...
            <div class="cta-row">
                ...
                <a class="btn btn-ghost" href="{{ route('rooms') }}">
    ...
    <section class="section-alt" aria-labelledby="rooms-teaser-heading">
        ...
        <div class="container">
                ...
                @foreach ($featuredRooms as $room)
                    <article class="room-card">
                        ...
                        <figure>
                            ...
                            <img src="{{ Str::startsWith($room->image_path, 'http') ? $room->image_path : asset($room->image_path) }}"
                                alt="{{ $room->name }}">
            ...
            <div style="margin-top: 2.4rem;">
                ...
                <a class="btn btn-primary" href="{{ route('rooms') }}">
    ...
    @if ($featuredTestimonial)
        <section class="section-dark" aria-labelledby="quote-heading">
            ...
            <div class="container">
                ...
                <h2 id="quote-heading" style="max-width: 20ch;">
                ...
                <p style="opacity:0.85; max-width: 50ch;">
                    ...
                    <a href="{{ route('testimonials') }}" style="color: var(--ochre);">
